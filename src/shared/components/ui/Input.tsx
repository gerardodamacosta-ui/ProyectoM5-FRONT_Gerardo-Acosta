...
// text-gray-900 explícito: sin esto el input hereda el color de texto del contenedor
// (ej. queda blanco e ilegible dentro de AdminLayout, que tiene fondo oscuro)
const BASE_CLASSES =
  'w-full rounded-lg border px-3 py-2 text-sm text-gray-900 outline-none transition-colors focus:ring-2 sm:text-base'

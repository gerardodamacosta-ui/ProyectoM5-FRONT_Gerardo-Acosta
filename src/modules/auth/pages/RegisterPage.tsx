...
export function RegisterPage() {
  ...
  // con sesión activa el registro no tiene sentido → al home (cubre también el post-registro)
  ...
  return (
    ...
    <main className="flex min-h-screen items-center justify-center bg-brand-50 p-4">
      <section className="w-full max-w-md rounded-xl bg-white p-6 shadow-md sm:p-8">
        ...
        {/* separador visual entre el registro con email y el de Google */}
        ...
        {/* acceso al login para quien ya tiene cuenta */}
